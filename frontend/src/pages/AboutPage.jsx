    ...
    <div className="font-sans text-gray-800 bg-white">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-emerald-50 p-10 rounded-3xl border border-emerald-100 shadow-sm">
            <h3 className="text-2xl font-bold mb-6 text-emerald-800 font-serif">
              Why ResQPlate?
            </h3>
            <ul className="space-y-4 text-gray-700 text-lg">
              <li className="flex items-center gap-3">
                <span className="bg-emerald-200 text-emerald-700 rounded-full p-1">✔</span> Reduces food wastage efficiently
              </li>
              <li className="flex items-center gap-3">
                <span className="bg-emerald-200 text-emerald-700 rounded-full p-1">✔</span> Supports NGOs & volunteers
              </li>
              <li className="flex items-center gap-3">
                <span className="bg-emerald-200 text-emerald-700 rounded-full p-1">✔</span> Ensures safe & timely food pickup
              </li>
              <li className="flex items-center gap-3">
                <span className="bg-emerald-200 text-emerald-700 rounded-full p-1">✔</span> Promotes sustainable communities
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-shadow border border-gray-100">
              <div className="text-5xl mb-6 bg-emerald-50 w-20 h-20 mx-auto rounded-2xl flex items-center justify-center">🍽️</div>
              <h3 className="text-2xl font-bold mb-3">Food Rescue</h3>
              <p className="text-gray-600 leading-relaxed">
                Prevents edible food from being discarded by redirecting it to NGOs in need.
              </p>
            </div>

            <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-shadow border border-gray-100">
              <div className="text-5xl mb-6 bg-emerald-50 w-20 h-20 mx-auto rounded-2xl flex items-center justify-center">📍</div>
              <h3 className="text-2xl font-bold mb-3">Smart Matching</h3>
              <p className="text-gray-600 leading-relaxed">
                Uses location-based algorithms to notify nearby verified receivers instantly.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="bg-emerald-50 p-8 rounded-3xl border border-emerald-100">
              ...
              <h4 className="text-xl font-bold mb-3 text-emerald-800">Food Safety</h4>
            ...
            <div className="bg-emerald-50 p-8 rounded-3xl border border-emerald-100">
              ...
              <h4 className="text-xl font-bold mb-3 text-emerald-800">Secure Access</h4>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-emerald-50 p-8 rounded-3xl border border-emerald-100">
              <div className="text-4xl mb-4">⚖️</div>
              <h4 className="text-xl font-bold mb-3 text-emerald-800">Transparency</h4>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-emerald-50 p-8 rounded-3xl border border-emerald-100">
              <div className="text-4xl mb-4">🌍</div>
              <h4 className="text-xl font-bold mb-3 text-emerald-800">Social Impact</h4>
              <p className="text-gray-600 text-sm">
